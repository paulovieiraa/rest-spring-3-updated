...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
  public static final String MSG_GENERIC_ERROR_FOR_FINAL_USER =
  ...
  public ResponseEntity<Object> handleUncaught(Exception ex, WebRequest request) {
    ...
    Problem problem =
        createProblemBuilder(status, problemType, MSG_GENERIC_ERROR_FOR_FINAL_USER)
            .exception(exception)
            .build();
  ...
  public ResponseEntity<?> handlerBusiness(BusinessException ex, WebRequest request) {
    ...
    Problem problem =
        createProblemBuilder(status, problemType, detail).exception(exception).build();
